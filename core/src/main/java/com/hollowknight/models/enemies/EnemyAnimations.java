...
public enum EnemyAnimations {
    ...
    HORNHEAD_DEATH("animation/Husk_Hornhead/Death.png", 9, 2f, AnimationType.ONESHOT),
    ...
    FALSE_KNIGHT_JUMP_ATTACK("animation/False_knight/JumpAttack.png", 12,
            6f * FalseKnight.JUMP_ATTACK_SPEED_Y / (-Constants.GRAVITY * 2f), AnimationType.ONESHOT),
